  ...
  <div class="app-container">
    ...
    <el-col>
      ...
      <el-table v-loading="loading" size="medium" :data="userList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="邮箱" align="center" key="email" prop="email" width="160" />
        <el-table-column label="状态" align="center" key="status" width="180">
          <template slot-scope="scope">
            <el-switch v-model="scope.row.status" active-value="NORMAL" inactive-value="NORMAL"
    ...
    <el-dialog :title="title" @close="handleClose" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="110px" style="padding-left: 29px">
        <el-row>
          <el-col :span="22">
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      pageAllUser(queryParams).then(res => {
